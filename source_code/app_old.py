...
def predict_insurance():
    # Get the insurance_data from the POST request
    insurance_data = request.get_json()

    # Print the insurance_data with a heading
    print("Received Insurance Data:")
    print(insurance_data)

    # Your prediction logic here (replace with your actual implementation)
    # ...
